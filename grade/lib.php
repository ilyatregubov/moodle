...
class grade_structure {
    ...
    */
     ...
     * @deprecated since Moodle 4.4 - The row is not shown anymore - we have actions menu.
    ...
    public function get_element_type_string(array $element): string {
        debugging('The function get_element_type_string() is deprecated, please use grade_helper::get_element_type_string() instead.',
            DEBUG_DEVELOPER);
...
abstract class grade_helper {
     ...
     * @return string icon or spacer
     */
    public static function get_element_icon(array &$element, bool $spacerifnone=false) {
        global $CFG, $OUTPUT;
        require_once $CFG->libdir.'/filelib.php';
