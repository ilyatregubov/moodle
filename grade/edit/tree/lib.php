...
class grade_edit_tree {
    ...
    public function build_html_tree($element, $totals, $parents, $level, &$row_count) {
        ...
        $eid    = $element['eid'];
        $object->name = grade_helper::get_element_header($element, true, false, true, false, true);
        $object->icon = grade_helper::get_element_icon($element);
        $object->type = grade_helper::get_element_type_string($element);
        $object->stripped_name = grade_helper::get_element_header($element, false, false, false);
