...
class lib_test extends \advanced_testcase {
    ...
    public function test_get_gradable_users() {
        ...
        $gradableusers = grade_report_get_gradable_users($course->id);
        ...
        $gradableusers = grade_report_get_gradable_users($course->id, $group1->id);
        ...
        $gradableusers = grade_report_get_gradable_users($course->id, $group2->id);
