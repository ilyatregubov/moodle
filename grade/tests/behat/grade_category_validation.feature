...
#    Given I click on grade category menu "<span lang=\"en\" class=\"multilang\">EN</span><span lang=\"fr\" class=\"multilang\">FR</span> Cat 1"
    Given I click on grade item menu "ENFR Cat 1" of type "category" on "setup" page
    ...
    And I click on grade item menu "ENFR Cat 1" of type "category" on "setup" page
    And I choose "Edit category" in the open action menu
  ...
  Scenario: Attempting to change a category item's scale when overridden grades already exist
    ...
    And I turn editing mode on
    And I give the grade "C" to the user "Student 1" for the grade item "ENFR Cat 1 total"
    And I press "Save changes"
    And I navigate to "Setup > Gradebook setup" in the course gradebook
    And I click on grade item menu "ENFR Cat 1" of type "category" on "setup" page
    And I choose "Edit category" in the open action menu
