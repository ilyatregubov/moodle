...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_modalform=_interopRequireDefault(_modalform),_notification=_interopRequireDefault(_notification);_exports.init=()=>{document.addEventListener("click",(event=>{if(event.target.closest('[data-trigger="add-item-form"]')){event.preventDefault();const trigger=event.target.closest('[data-trigger="add-item-form"]'),params=(()=>{const args={},isGradeItem=trigger.getAttribute("data-itemid"),isGradeCategory=trigger.getAttribute("data-category");return args.args={courseid:trigger.getAttribute("data-courseid")},isGradeItem?(args.formClass="core_grades\\form\\add_item",args.title="-1"===trigger.getAttribute("data-itemid")?(0,_str.get_string)("newitem","core_grades"):(0,_str.get_string)("itemsedit","core_grades"),args.args.itemid=trigger.getAttribute("data-itemid")):isGradeCategory&&(args.formClass="core_grades\\form\\add_category",args.title="-1"===trigger.getAttribute("data-category")?(0,_str.get_string)("newcategory","core_grades"):(0,_str.get_string)("categoryedit","core_grades"),args.args.category=trigger.getAttribute("data-category")),args})(),modalForm=new _modalform.default({modalConfig:{title:params.title},formClass:params.formClass,args:params.args,saveButtonText:(0,_str.get_string)("save","core"),returnFocus:trigger});modalForm.addEventListener(modalForm.events.FORM_SUBMITTED,(event=>{event.detail.result?window.location.assign(event.detail.url):_notification.default.addNotification({type:"error",message:(0,_str.get_string)("saving_failed","core_grades")})})),modalForm.show()}}))}}));
