...
namespace core_grades\local\systemreports;

use core_grades\local\entities\grade_items;
...
class summary extends system_report {
    ...
    protected function initialise(): void {
        ...
        $wheresql = "$entitymainalias.courseid = :$param AND $entitymainalias.itemtype <> 'course' AND $entitymainalias.itemtype <> 'category'";
        $this->add_base_condition_sql($wheresql, [$param => $courseid]);
