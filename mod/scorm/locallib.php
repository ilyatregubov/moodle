...
function scorm_get_sco_runtime($scormid, $scoid, $userid, $attempt=1) {
    ...
    $timedata = $DB->get_record($sql, $params);
    if (!empty($timedata)) {
        return $timedata;
    } else {
 ...
 * @return mixed
 */
function scorm_get_sco_value($scoid, $userid, $element, $attempt = null) {
    global $DB;
 ...
 * @return stdclass
 */
function scorm_get_attempt($userid, $scormid, $attempt, $create = true) {
    global $DB;
    $attemptobject = $DB->get_record('scorm_attempt', ['scormid' => $scormid,
                                                       'userid' => $userid,
                                                       'attempt' => $attempt]);
 ...
 */
function scorm_get_elementid($elementname) {
    global $DB;
