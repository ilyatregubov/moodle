...
class lib_test extends advanced_testcase {
    ...
    public function test_h5pactivity_fetch_recent_activity() {
        ...
        $this->assertEquals($students[1]->id, $recentactivity[0]->userid);
        ...
        $this->assertEquals($students[1]->id, $recentactivity[0]->userid);
        $this->assertEquals($students[3]->id, $recentactivity[1]->userid);
        ...
        $this->assertEquals($students[2]->id, $recentactivity[0]->userid);
        ...
        $this->assertEquals($students[1]->id, $recentactivity[0]->userid);
        $this->assertEquals($students[2]->id, $recentactivity[1]->userid);
    }
}
