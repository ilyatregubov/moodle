...
$string['erroraddtogroup'] = 'Incorrect value for addtogroup. Accepted values are 0 or 1';
$string['erroraddtogroupgroupname'] = 'You can not specify groupname when Add to group option is \'None\' or \'Create a new group\'';
