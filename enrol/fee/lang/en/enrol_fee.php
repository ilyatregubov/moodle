...
$string['enrolenddateformaterror'] = 'Wrong enrolment end date format. Example: 1/1/2010';
$string['enrolperiod'] = 'Enrolment duration';
$string['enrolperiod_desc'] = 'Default length of time that the enrolment is valid. If set to zero, the enrolment duration will be unlimited by default.';
$string['enrolperiod_help'] = 'Length of time that the enrolment is valid, starting with the moment the user is enrolled. If disabled, the enrolment duration will be unlimited.';
$string['enrolperiodformaterror'] = 'Wrong enrolment period format. Example: 2 weeks, 1 month, 1 year...';
$string['enrolstartdate'] = 'Start date';
$string['enrolstartdate_help'] = 'If enabled, users can only be enrolled from this date onwards.';
$string['enrolstartdateformaterror'] = 'Wrong enrolment start date format. Example: 1/1/2010';
$string['errorcurrency'] = 'Unknown currency: {$a}';
$string['errorpaymentaccount'] = 'Unknown payment account: {$a}';
