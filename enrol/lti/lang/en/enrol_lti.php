...
$string['unsupportedltiversion'] = 'Unsupported LTI version';
$string['errormaxenrolledformat'] = 'Max enrolled should be positive integer';
$string['errorprovisioningmodeteacherlaunch'] = 'Unexpected teacher first launch provisioning mode';
$string['errorprovisioningmodelearner'] = 'Unexpected student first launch provisioning mode';
$string['errormembersyncmode'] = 'Unexpected user synchronisation mode';
$string['errormaildisplay'] = 'Unexpected email visibility mode';
$string['errorcountry'] = 'Unexpected country';
$string['errortimezone'] = 'Unexpected time zone';
$string['errorlang'] = 'Unexpected preferred language';
$string['errortooltobeprovided'] = 'Unexpected tool to be published: {$a}. It should be either a course name or an activity name within a given course. Defaulting to course';
$string['errorroleinstructor'] = 'Unexpected role for teacher';
$string['errorrolelearner'] = 'Unexpected role for student';
$string['errorcompletionenabled'] = 'Completion should be enabled for {$a} when requirecompletion is set';
...
$string['plugindisabled'] = 'Publish as LTI tool enrolment plugin is disabled';
