 ...
 */
function aggregate_completions(int $coursecompletionid) {
    global $DB;

    if (!$coursecompletionid && debugging() && !PHPUNIT_TEST) {
 ...
 */
function mark_course_completions_activity_criteria($userdata = null): int {
    global $DB;
